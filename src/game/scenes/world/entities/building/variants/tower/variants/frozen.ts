...
export class BuildingTowerFrozen extends BuildingTower {
  ...
  static Params: BuildingParam[] = [
    {
      label: "Health",
      value: DIFFICULTY.BUILDING_TOWER_FROZEN_HEALTH,
      icon: BuildingIcon.HEALTH,
    },
    {
      label: "Radius",
      value: DIFFICULTY.BUILDING_TOWER_FROZEN_RADIUS,
      icon: BuildingIcon.RADIUS,
    },
    // eslint-disable-next-line max-len
    {
      label: "Freeze",
      value: `${(
        DIFFICULTY.BUILDING_TOWER_FROZEN_FREEZE_DURATION / 1000
      ).toFixed(1)} s`,
      icon: BuildingIcon.DAMAGE,
    },
    {
      label: "Speed",
      value: DIFFICULTY.BUILDING_TOWER_FROZEN_SHOT_SPEED,
