...
export class BuildingTowerFire extends BuildingTower {
  ...
  static Params: BuildingParam[] = [
    {
      label: "Health",
      value: DIFFICULTY.BUILDING_TOWER_FIRE_HEALTH,
      icon: BuildingIcon.HEALTH,
    },
    {
      label: "Radius",
      value: DIFFICULTY.BUILDING_TOWER_FIRE_RADIUS,
      icon: BuildingIcon.RADIUS,
    },
    {
      label: "Damage",
      value: DIFFICULTY.BUILDING_TOWER_FIRE_DAMAGE,
      icon: BuildingIcon.DAMAGE,
    },
    {
      label: "Speed",
      value: DIFFICULTY.BUILDING_TOWER_FIRE_SHOT_SPEED,
